...
namespace Memcury
{
    ...
    public:
        ...
        static auto FindStringRef(T string, bool find_first = false, bool MsgBox = true) -> Scanner
        {
            PE::Address add { nullptr };
           ...
           /* if (add == 0) {
                std::wcout << "Failed To Find " << string << std::endl;
            }*/
    ...
    namespace VEHHook
    {
        ...
        inline bool Init()
        {
            ...
            {
                std::cout << "INIT VEHHOOK" << std::endl;
